...
class FluentPatient:  # In real implementation: class FluentPatient(Patient)
    ...
    def plot(self, measurement_type: str, age_group: str | None = None, **kwargs: Any) -> Self:
        """
...
if __name__ == "__main__":
    ...
    patient = (
        FluentPatient(sex="M", birthday_date=datetime.date(2022, 1, 1))
        .measured_at(datetime.date(2022, 7, 1), weight=8.6, stature=68.4)
        .measured_at(datetime.date(2023, 1, 1), weight=10.2, stature=75.7)
        .calculate_all()
    )
    ...
    patient2 = (
        FluentPatient(sex="F", birthday_date=datetime.date(2022, 6, 15))
    ...
    print("Patient created, calculated, and plotted")
