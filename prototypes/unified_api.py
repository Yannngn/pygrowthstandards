...
class API:
    ...
    def patient(sex: str,
                ...
                **kwargs: Any) -> Any:  # Returns PatientBuilder
        """
    ...
    def quick_patient(sex: str,
                      ...
                      gestational_age_weeks: int = 40) -> Any:  # Returns Patient
        """
    ...
    @staticmethod
    def batch_calculate(data: Any,  # pd.DataFrame
                        measurement_col: str,
                        value_col: str,
                        sex_col: str,
                        age_days_col: str | None = None,
                        gestational_age_col: str | None = None,
                        method: str = "zscore") -> Any:  # pd.DataFrame
        """
...
if __name__ == "__main__":
    ...
    patient_obj = (patient(sex="M", birthday="2022-01-01")
        .measured_at("2022-07-01", weight=8.6, stature=68.4)
