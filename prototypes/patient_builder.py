        ...
        if self._birthday and self._measurements:
            for m in self._measurements:
                if m["date"] < self._birthday:
                    raise ValueError(
                        f"Measurement date {m['date']} is before birthday {self._birthday}"
                    )
...
if __name__ == "__main__":
    ...
    preterm_patient = (PatientBuilder()
        .female()
        .preterm(weeks=35)
        .born_on("2023-01-15")
    ...
    print(f"Built preterm patient with birth measurements")
    ...
    measurements = [
        {"date": "2022-07-01", "weight": 8.6, "stature": 68.4, "head_circumference": 44.5},
        {"date": "2023-01-01", "weight": 10.2, "stature": 75.7, "head_circumference": 46.5},
        {"date": "2024-01-01", "weight": 12.6, "stature": 87.8, "head_circumference": 48.5}
    ]
    
    patient_bulk = (PatientBuilder()
        .male()
        .born_on("2022-01-01")
    ...
    descriptive_patient = (PatientBuilder()
        .female()
        .full_term()
        .born_on("2023-06-15")
